...
final class Version20240602140646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE loyalty_levels (id UUID NOT NULL, loyalty_program_id UUID DEFAULT NULL, NAME VARCHAR(255) NOT NULL, value_factor INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_301C2C688364CCED ON loyalty_levels (loyalty_program_id)');
        $this->addSql('COMMENT ON COLUMN loyalty_levels.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN loyalty_levels.loyalty_program_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE loyalty_levels ADD CONSTRAINT FK_301C2C688364CCED FOREIGN KEY (loyalty_program_id) REFERENCES loyalty_programs (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE loyalty_levels DROP CONSTRAINT FK_301C2C688364CCED');
        $this->addSql('ALTER TABLE loyalty_programs DROP CONSTRAINT FK_A34D469B9393F8FE');
        $this->addSql('DROP TABLE invitations');
        $this->addSql('DROP TABLE loyalty_levels');
